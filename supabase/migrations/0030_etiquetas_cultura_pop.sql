...
update public.match_tags t
  ...
  from (values
    ('etiqueta-30', 'Ajedrecista en mis ratos libres',         1),
    ('etiqueta-15', 'Aquí solo por el cotilleo',               2),
    ('etiqueta-28', 'Clara con limón y sin vergüenza',         3),
    ('etiqueta-19', 'Coleccionista de funkos',                 4),
    ...
    ('etiqueta-20', 'Juego al Catan como si fuera la guerra',  12),
    ('etiqueta-8',  'Karaoke = planazo',                       13),
