...
update public.match_tags t
  ...
  from (values
    ('etiqueta-15', 'Aquí solo por el cotilleo',               1),
    ('etiqueta-28', 'Clara con limón y sin vergüenza',         2),
    ('etiqueta-19', 'Coleccionista de funkos',                 3),
    ('etiqueta-30', 'De cañas con Chanquete',                  4),
    ('etiqueta-9',  'De cañas con colegas',                    5),
    ('etiqueta-6',  'De cañas con Don Quijote',                6),
    ('etiqueta-8',  'De cañas con Fernando Alonso',            7),
    ('etiqueta-7',  'De cañas con... Mejor me callo',          8),
    ('etiqueta-10', 'De cañas con quien sea',                  9),
    ('etiqueta-4',  'Digo "bro" 4 veces por frase',            10),
    ('etiqueta-11', 'Farmeo aura',                             11),
    ('etiqueta-24', 'Hago masa madre',                         12),
    ...
    ('etiqueta-18', 'Swiftie',                                 24),
    ('etiqueta-29', 'Team 0,0',                                25),
    ('etiqueta-26', 'Te gano a un hidalgo',                    26),
    ('etiqueta-21', 'Tengo un podcast (lo escucha mi madre)',  27),
    ('etiqueta-12', 'Therian',                                 28),
    ('etiqueta-16', 'Tonto el que no lea',                     29),
