...
const styles = StyleSheet.create({
  ...
  // cuadrada y el telefono no). 0.05 literal: practicamente un susurro, a
  // proposito (a 0.1 ya casi no se veia).
  fondo: { position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, opacity: 0.05 },
